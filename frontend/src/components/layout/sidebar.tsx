...
// Навигация внутреннего персонала площадки (owner/admin/support/analyst).
...
// Навигация кабинета мерчанта/трейдера — видит только свои данные.
const merchantNavigation = [
  { key: "dashboard", href: "/merchant", icon: LayoutDashboard },
  { key: "transactions", href: "/merchant/transactions", icon: ArrowLeftRight },
  { key: "requisites", href: "/merchant/requisites", icon: CreditCard },
  { key: "disputes", href: "/disputes", icon: AlertTriangle },
];
...
export function Sidebar() {
  ...
  const navigationKeys = isMerchant ? merchantNavigation : staffNavigation;
      ...
      <div className="flex h-16 items-center gap-3 border-b border-border px-4">
        ...
        {!collapsed && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <p className="text-sm font-bold tracking-tight">BrudaPay</p>
